...
//  BizQuiz
//
//  Created by Taryn Neal on 1/27/19.
//  Copyright © 2019 Taryn Neal. All rights reserved.
//

import UIKit

class BusinessSkillsViewController : UIViewController {
    let allQuestions = BusinessSkillsQuestionBank()
    let allAnswers = BusinessSkillsAnswerBank()
