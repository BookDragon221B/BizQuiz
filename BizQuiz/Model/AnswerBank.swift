...
class ParliAnswerBank {
    ...
    init() {
        ...
        answer.append(Answer(text:"B) May be made only after they are read to the assembly"))
        answer.append(Answer(text:"C) Should be made in the minutes of the current meeting"))
        ...
        //Question 8
        answer.append(Answer(text:"A) The electing body names a chairman"))
        ...
        answer.append(Answer(text:"B) The presiding officer must vote to break the tie"))
        answer.append(Answer(text:"C) The vote can be reconsidered if moved by the one who voted yes"))
        ...
        //Question 14
        answer.append(Answer(text:"A) Only incidental motions can be reconsidered"))
        answer.append(Answer(text:"B) Only incidental motions have pending subsidary motions"))
        answer.append(Answer(text:"C) Original motions have objection to consideration of a question"))
        answer.append(Answer(text:"D) Incidental motions require only a majority vote"))
...
class NationalOfficeAnswerBank {
    ...
    init() {
        ...
        answer.append(Answer(text:"C) A recommendation by their chapter advisers"))
        ...
        answer.append(Answer(text:"D) The candidate has filed a request with the board of directors"))
